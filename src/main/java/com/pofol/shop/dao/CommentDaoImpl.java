...
public class CommentDaoImpl implements CommentDao {
	...
	private static String namespace = "com.pofol.shop.dao.CommentMapper.";
	...
	@Override
	public List searchSelect(Integer bno, SearchCondition sc) throws Exception {
		Map map = new HashMap();
		map.put("bno", bno);
		map.put("offset", sc.getOffset());
		map.put("pageSize", sc.getPageSize());
//		System.out.println((new StringBuilder("List<CommentDto> = "))
//				.append(session.selectList(
//						(new StringBuilder(String.valueOf(namespace))).append("searchSelect").toString(), map))
//				.toString());
